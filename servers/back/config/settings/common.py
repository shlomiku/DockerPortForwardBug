...
ROOT_DIR = environ.Path(__file__) - 2  # (modules/config/settings/common.py - 3 = modules/)
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'modules.contrib.sites.migrations'
}
...
STATICFILES_DIRS = (
    ...
    str(APPS_DIR.path('../client/scss')),
    str(APPS_DIR.path('../client/assets')),
...
MESSAGE_TYPES_LIST = [MSG_TYPE_MESSAGE,
                      MSG_TYPE_WARNING,
                      MSG_TYPE_ALERT,
                      MSG_TYPE_MUTED,
                      MSG_TYPE_ENTER,
